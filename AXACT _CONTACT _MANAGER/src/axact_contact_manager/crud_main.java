		...
		try {
			...
			do {
				...
				case "1":
					...
					query = "INSERT INTO tbl_contact (first_name, last_name, email, phone_number, address)VALUES('"
							+ f_name + "','" + l_name + "','" + email + "','" + p_n + "','" + adrs + "') ";
					stmt.executeUpdate(query);
					System.out.println();
				...
				case "5":
					...
					while (ars.next()) {
						...
						System.out.println(
								"Full Name: " + ars.getString("first_name") + " " + ars.getString("last_name"));
